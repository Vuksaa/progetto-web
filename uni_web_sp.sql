...
CREATE OR REPLACE PROCEDURE product_order_remove (IN p_productId INT(11),p_orderId INT(11))
  ...
  END;
//
CREATE OR REPLACE PROCEDURE provider_add (IN p_name VARCHAR (90),IN p_address VARCHAR (90),IN p_email VARCHAR (45),IN p_password VARCHAR (45))
  BEGIN
    INSERT INTO provider (provider.provider_name,provider.provider_address,provider.provider_email,provider.provider_password) VALUES (p_name,p_address,p_email,p_password);
  END;
//
