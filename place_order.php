...
<body>
  ...
  <div class="container mt-4 mb-4">
    <h1 class="display-4 mb-4 text-center text-sm-left">Crea ordine</h1>
    <div class="accordion mt-4 mb-4" id="mainAccordion">
      <section>
        <h2 class="mb-0" id="headingMenu">
          <button class="btn btn-secondary btn-lg btn-block active mb-1" data-toggle="collapse" data-target="#collapseMenu" aria-expanded="true" aria-controls="collapseMenu">
            Men&ugrave;
          </button>
        </h2>
      ...
      <section>
        <h2 class="mb-0" id="headingOrder">
          <button class="btn btn-secondary btn-lg btn-block active mb-1" data-toggle="collapse" data-target="#collapseOrder" aria-expanded="false" aria-controls="collapseOrder">
            Ordine
          </button>
        </h2>
      ...
      <section>
        <h2 class="mb-0" id="headingConfirmation">
          <button class="btn btn-secondary btn-lg btn-block active mb-1" data-toggle="collapse" data-target="#collapseConfirmation" aria-expanded="false" aria-controls="collapseConfirmation">
