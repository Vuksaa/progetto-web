    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title ml-2 mr-2" id="modalLabelReject">Rifiuta ordine</h4>
        ...
        <div class="modal-body ml-2 mr-2">
          ...
          <textarea maxlength="200" class="form-control" aria-labelledby="rejectLabel" id="rejectNotes"></textarea>
        </div>
